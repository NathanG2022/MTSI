...
# Patch gpt4all to use importlib_resources if Python < 3.9
...
gpt4all._pyllmodel.files = patched_files
...
model_complete_filepath = "C:/Users/natha/AppData/Roaming/nomic.ai/GPT4All/gpt4all-falcon-newbpe-q4_0.gguf"
